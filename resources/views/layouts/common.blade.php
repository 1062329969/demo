    ...
    <div class="navbar-inner">
        <div class="container-fluid">
            ...
            <a class="brand" href="index.html">
                <img src="{{ asset('img/logo.png') }}" alt="Metro Lab" />
            </a>
            <!-- END LOGO -->
    ...
    <div class="sidebar-scroll">
        <div id="sidebar" class="nav-collapse collapse">
            ...
            <ul class="sidebar-menu">
                <li class="sub-menu @if (Request::path() == '/') active @endif">
                    <a class="" href="/">
                        <i class="icon-dashboard"></i>
                        <span>首页</span>
                    </a>
                </li>
                <li class="sub-menu @if (Request::path() == 'home/add') active @endif">
                    <a class="" href="/home/add">
                        <i class="icon-book"></i>
                        <span>添加</span>
                    </a>
                </li>
...
<script src="{{ asset('js/home-chartjs.js') }}"></script>
